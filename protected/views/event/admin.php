...
<div class="bootstrap-widget">
    ...
    <div  class="bootstrap-widget-content">
        <?php echo CHtml::link('Add New Event', array('event/create'),array('class'=>'btn-primary btn')); ?>
        ...
        <?php
             $this->widget('bootstrap.widgets.TbExtendedGridView', array(
                ...
                'columns'=>array(
                    ...
                    array('name'=>'eventname', 'value'=>'$data->eventname', 'filterHtmlOptions'=>array('style'=>'width:250px;')),
                    array('name'=>'status',
